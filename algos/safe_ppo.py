...
class SafePPO_GBRL(PPO_GBRL):
    ...
    def __init__(self, *args, **kwargs):
        self.cost_threshold: float = float(kwargs.pop("cost_threshold", 100.0)) # https://arxiv.org/html/2409.01245v1
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                if use_safety:
                    if self.use_safety_projection:
                        ...
                        exp_ep_cost = self.current_cost_estimate #rollout_data.cost_returns.mean().item()
